$(function(){
    ...
    $('.teacher-btn').on('click', function(e) { 
        window.location.href = 'teacher.php?id='+$(this).parent().parent().data('teacherId');
    });
    ...
    $('#detail-edit-btn').on('click', function(e) {
        ...
        $("#batch [data-batch-id="+$("#details-modal").data("batchId")+"] .edit-btn").click();
    });

    $('#detail-delete-btn').on('click', function(e) {
        $(this).parent().parent().parent().click();
        $("#batch [data-batch-id="+$("#details-modal").data("batchId")+"] .delete-btn").click();
    });
