$(function(){
    ...
    if(getParam('id')!=null) {
        setTimeout(function() {
            $("#student [data-student-id="+getParam('id')+"] .details-btn").click();
        },10);
    }
    ...
    $('.batch-btn').on('click', function(e) { 
        window.location.href = 'batch.php?id='+$(this).parent().parent().data('batchId');
    });
    ...
    $('#detail-edit-btn').on('click', function(e) {
        ...
        $("#student [data-student-id="+$("#details-modal").data("studentId")+"] .edit-btn").click();
    });

    $('#detail-delete-btn').on('click', function(e) {
        $(this).parent().parent().parent().click();
        $("#student [data-student-id="+$("#details-modal").data("studentId")+"] .delete-btn").click();
    });
