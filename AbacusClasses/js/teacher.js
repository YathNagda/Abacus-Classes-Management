$(function(){
    ...
    if(getParam('id')!=null) {
        setTimeout(function() {
            $("#teacher [data-teacher-id="+getParam('id')+"] .details-btn").click();
        },10);
    }
    ...
    $('#detail-edit-btn').on('click', function(e) {
        ...
        $("#teacher [data-teacher-id="+$("#details-modal").data("teacherId")+"] .edit-btn").click();
    });

    $('#detail-delete-btn').on('click', function(e) {
        $(this).parent().parent().parent().click();
        $("#teacher [data-teacher-id="+$("#details-modal").data("teacherId")+"] .delete-btn").click();
    });
