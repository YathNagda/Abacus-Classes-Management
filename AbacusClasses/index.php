...
<body>
    <header class="expanded">
        ...
        <nav>
            ...
            <a href="#contact" class="button flat">Contact Us</a>
    ...
    <main>
        ...
        <div id="contact"></div>
        <h2 class="fancy span6">Contact Us</h2>
        <div id="contact-card" class="card grid span6">
            ...
            <!-- <form id="contact-form" method="post">
                <label class="textfield name">
                    <input type="text" name="name" placeholder=" " required>
                    <span>Name</span>
                </label>
                <label class="textfield contact">
                    <input type="text" name="contact" placeholder=" " required>
                    <span>Phone/Email</span>
                </label>
                <label class="textfield message">
                    <textarea name="content" rows="4" placeholder=" " required></textarea>
                    <span>Message</span>
                </label>
                <button id="contact-submit" class="button" type="submit">Send</button>
            </form> -->
        </div>
    </main>
    <?php
